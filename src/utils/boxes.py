...
def rescale_bboxes(out_bbox, size):
    ...
    # Match the prediction tensor's device (CUDA during packaged inference).
    # Creating this scale on CPU caused every GPU detection frame to fail.
    scale = out_bbox.new_tensor([img_w, img_h, img_w, img_h])
    b = b * scale
    return b
